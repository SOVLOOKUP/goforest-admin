...
type SysUser struct {
    ...
    Username   string      `orm:"username,unique" json:"Username,omitempty" gconv:"Username,omitempty"`      
    Password   string      `orm:"password"        json:"Password,omitempty" gconv:"Password,omitempty"`      
    Salt       string      `orm:"salt"            json:"Salt,omitempty" gconv:"Salt,omitempty"`              
    Mobile     string      `orm:"mobile"          json:"Mobile,omitempty" gconv:"Mobile,omitempty"`          
    CreateTime *gtime.Time `orm:"create_time"     json:"CreateTime,omitempty" gconv:"CreateTime,omitempty"`  
    UpdateTime *gtime.Time `orm:"update_time"     json:"UpdateTime,omitempty" gconv:"UpdateTime,omitempty"`  
    Status     int         `orm:"status"          json:"Status,omitempty" gconv:"Status,omitempty"`          
}
...
func (model SysUser) columns() string {
    sqlColumns := "t.create_time as CreateTime,t.update_time as UpdateTime,t.status as Status,t.id as Id,t.username as Username,t.password as Password,t.salt as Salt,t.mobile as Mobile"
    return sqlColumns
}
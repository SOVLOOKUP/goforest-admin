...
type SysOss struct {
    ...
    Url        string      `orm:"url"         json:"Url,omitempty" gconv:"Url,omitempty"`                
...
func (model SysOss) columns() string {
    sqlColumns := "t.url as Url,t.create_time as CreateTime,t.update_time as UpdateTime,t.status as Status,t.id as Id"
    return sqlColumns
}
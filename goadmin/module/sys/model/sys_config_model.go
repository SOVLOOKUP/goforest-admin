...
type SysConfig struct {
    ...
    ParamKey   string      `orm:"param_key,unique" json:"ParamKey,omitempty" gconv:"ParamKey,omitempty"`      
    ParamValue string      `orm:"param_value"      json:"ParamValue,omitempty" gconv:"ParamValue,omitempty"`  
    Remark     string      `orm:"remark"           json:"Remark,omitempty" gconv:"Remark,omitempty"`          
...
func (model SysConfig) columns() string {
    sqlColumns := "t.param_key as ParamKey,t.param_value as ParamValue,t.remark as Remark,t.create_time as CreateTime,t.update_time as UpdateTime,t.status as Status,t.id as Id"
    return sqlColumns
}